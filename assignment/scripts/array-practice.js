...
let favFoods = ['thai red curry', 'chocolate chip cookies', 'tikka masala'];
...
console.log('Favorite foods ar enow:', favFoods);
...
let foodsAndAnimals = [];
console.log(foodsAndAnimals.concat(favFoods, animalArray));